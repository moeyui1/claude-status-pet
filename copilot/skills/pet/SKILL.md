...
> **For plugin install:** Run `/plugin update claude-status-pet@claude-status-pet` inside Copilot CLI — this updates hooks and skill automatically. Then follow steps 1-2 and 5 below for binary and assets.
>
